...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        write_bytes = np.array(write_bytes)
        read_bytes = np.array(read_bytes)
        plt.plot(time, mem)
        ...
        plt.show()
        plt.close()
        plt.plot(time, write_bytes)
        plt.title("Written bytes")
        plt.xlabel("Time, ms")
        plt.ylabel("Bytes written, Bytes")
        plt.show()
        plt.close()
        plt.plot(time, read_bytes)
        plt.title("Read bytes")
        plt.xlabel("Time, ms")
        plt.ylabel("Bytes read, Bytes")
        plt.show()
        plt.close()
    pass
